...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](01):[/cyan] [green]Increase Money ~ 3[/green]")
            console.print("[bold][cyan](02):[/cyan] [green]Increase Coins ~ 2[/green]")
            console.print("[bold][cyan](03):[/cyan] [green]King Rank ~ 4[/green]")
            console.print("[bold][cyan](04):[/cyan] [green]Change ID ~ 2[/green]")
            console.print("[bold][cyan](05):[/cyan] [green]Change Name ~ 7[/green]")
            console.print("[bold][cyan](06):[/cyan] [green]Change Name (Rainbow) ~ 4[/green]")
            console.print("[bold][cyan](07):[/cyan] [green]Number Plates ~ 3[/green]")
            ...
            console.print("[bold][cyan](10):[/cyan] [green]Delete Friends ~ 5[/green]")
            console.print("[bold][cyan](11):[/cyan] [green]Unlock Paid Cars ~ 2[/green]")
            console.print("[bold][cyan](12):[/cyan] [green]Unlock all Cars ~ 4[/green]")
            console.print("[bold][cyan](13):[/cyan] [green]Unlock all Cars Siren ~ 3[/green]")
            console.print("[bold][cyan](14):[/cyan] [green]Unlock w16 Engine ~ 6[/green]")
            console.print("[bold][cyan](15):[/cyan] [green]Unlock All Horns ~ 2[/green]")
            console.print("[bold][cyan](16):[/cyan] [green]Unlock Disable Damage ~ 5[/green]")
            console.print("[bold][cyan](17):[/cyan] [green]Unlock Unlimited Fuel ~ 3[/green]")
            console.print("[bold][cyan](18):[/cyan] [green]Unlock House 3 ~ 5[/green]")
            console.print("[bold][cyan](19):[/cyan] [green]Unlock Smoke ~ 2[/green]")
            console.print("[bold][cyan](20):[/cyan] [green]Change Race Wins ~ 3[/green]")
            console.print("[bold][cyan](21):[/cyan] [green]Change Race Loses ~ 2[/green]")
            console.print("[bold][cyan](22):[/cyan] [green]Clone Account ~ 3[/green]")
