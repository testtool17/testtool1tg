...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold][cyan](01):[/cyan] [green]Increase Money ~ 0[/green]")
            console.print("[bold][cyan](02):[/cyan] [green]Increase Coins ~ 0[/green]")
            console.print("[bold][cyan](03):[/cyan] [green]King Rank ~ 0[/green]")
            console.print("[bold][cyan](04):[/cyan] [green]Change ID ~ 0[/green]")
            console.print("[bold][cyan](05):[/cyan] [green]Change Name ~ 0[/green]")
            console.print("[bold][cyan](06):[/cyan] [green]Change Name (Rainbow) ~ 0[/green]")
            console.print("[bold][cyan](07):[/cyan] [green]Number Plates ~ 0[/green]")
            ...
            console.print("[bold][cyan](10):[/cyan] [green]Delete Friends ~ 0[/green]")
            console.print("[bold][cyan](11):[/cyan] [green]Unlock Paid Cars ~ 0[/green]")
            console.print("[bold][cyan](12):[/cyan] [green]Unlock all Cars ~ 0[/green]")
            console.print("[bold][cyan](13):[/cyan] [green]Unlock all Cars Siren ~ 0[/green]")
            console.print("[bold][cyan](14):[/cyan] [green]Unlock w16 Engine ~ 0[/green]")
            console.print("[bold][cyan](15):[/cyan] [green]Unlock All Horns ~ 0[/green]")
            console.print("[bold][cyan](16):[/cyan] [green]Unlock Disable Damage ~ 0[/green]")
            console.print("[bold][cyan](17):[/cyan] [green]Unlock Unlimited Fuel ~ 0[/green]")
            console.print("[bold][cyan](18):[/cyan] [green]Unlock House 3 ~ 0[/green]")
            console.print("[bold][cyan](19):[/cyan] [green]Unlock Smoke ~ 0[/green]")
            console.print("[bold][cyan](20):[/cyan] [green]Change Race Wins ~ 0[/green]")
            console.print("[bold][cyan](21):[/cyan] [green]Change Race Loses ~ 0[/green]")
            console.print("[bold][cyan](22):[/cyan] [green]Clone Account ~ 0[/green]")
