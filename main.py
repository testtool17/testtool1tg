...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @gala_original ')) 
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{01}: Increase Money           1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{02}: Increase Coins           1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{03}: King Rank                1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{04}: Change ID                1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{05}: Change Name              1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{06}: Change Name (Rainbow)    1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{07}: Number Plates            1.K'))
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{10}: Delete Friends           1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{11}: Unlock Paid Cars         1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{12}: Unlock all Cars          1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{13}: Unlock all Cars Siren    1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{14}: Unlock w16 Engine        1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{15}: Unlock All Horns         1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{16}: Unlock Disable Damage    1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{17}: Unlock Unlimited Fuel    1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{18}: Unlock House 3           1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{19}: Unlock Smoke             1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{20}: Change Race Wins         1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{21}: Change Race Loses        1.K'))
            print(Colorate.Horizontal(Colors.rainbow, '{22}: Clone Account            1.K'))
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.rainbow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.rainbow, '======================================'))
                    print(Colorate.Horizontal(Colors.rainbow, f'INFO: In order to tweak this account with cpmgala.'))
